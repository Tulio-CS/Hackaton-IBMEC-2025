...
def start_session():
    ...
    saudacao_inicial_bot = "Olá! Sou o GuIA Carreiras IBMEC. Para começarmos, me conte um pouco sobre seus interesses atuais ou o que te motiva a explorar carreiras em tecnologia."
